...
import { COUNTRY_CODE_CURRENCY } from "./utils/const";
...
export function convertToOrderSchemaExpected(
  input: any,
  countryOrder: string
): {
  ...
  const orderSchemaExpected: OrderSchemaExpected = {
    ...
    billing_address: {
      ...
      state_code:
        codeProvince(billingAddress.provinceCode, countryOrder) || "Sin datos"
    },
    shipping_address: {
    ...
    order_transaction: {
      ...
      currency:
        COUNTRY_CODE_CURRENCY[
          countryOrder as keyof typeof COUNTRY_CODE_CURRENCY
        ] || "COP",
